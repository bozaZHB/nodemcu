...
const char* ssid = "ZHB_WiFi";//put your hotspot ssid here
const char* password = "12345678";//put your hotspot password here
...
char msg[50];
int value = 0;
int threhold=50; // you might need to adjust this value to define light on/off status //prag za on/of
void setup_wifi() {
   delay(100);
  ...
  if (now - lastMsg > 500) {
   ...
   if (val>threhold)
     ...
     //publish sensor data to MQTT broker
      ...
      client.publish("bozaPub", message);
  }
}

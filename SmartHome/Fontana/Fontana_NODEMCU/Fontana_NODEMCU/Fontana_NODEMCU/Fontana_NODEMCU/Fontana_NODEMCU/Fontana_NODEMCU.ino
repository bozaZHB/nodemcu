...
void callback(char* topic, byte* payload, unsigned int length) 
{
  ...
  if (str =="bozaSub/kuca/node1/prskalica1"){
    ...
    if(p=='s'){
      client.publish("bozaSub/kuca/node1/stanje/stanje", Stanje,TRUE);
      delay(20);
      client.publish("bozaSub/kuca/node1/vreme1/stanje", String(vremeTajmera1).c_str(),TRUE);
      delay(20);
      client.publish("bozaSub/kuca/node1/vreme2/stanje", String(vremeTajmera2).c_str(),TRUE);
      delay(20);
      client.publish("bozaSub/kuca/node1/trajanje/stanje", String(trajanje).c_str(),TRUE);
    }
  }
...
void provera(){
  ...
  client.publish("bozaSub/kuca/node1/stanje/ukljucen", String("Node 1 fontana ukljucen").c_str(),TRUE);
}
void loop() {    
    if (!client.connected()) {
      reconnect();
  ...
  if (Serial.available() > 0) {
    ...
    if (incomingByte == 'q') {
      ...
      client.publish("bozaSub/kuca/node1/prskalica1/stanje", String("1").c_str(),TRUE);
    }
      ...
      Stanje[2]='0';
      Stanje[3]='0';
      client.publish("bozaSub/kuca/node1/prskalica1/stanje", String("0").c_str(),TRUE);
    }
      ...
      Stanje[2]='0';
      Stanje[3]='0';
      client.publish("bozaSub/kuca/node1/prskalica2/stanje", String("1").c_str(),TRUE);
    }
      ...
      Stanje[2]='0';
      Stanje[3]='0';
      client.publish("bozaSub/kuca/node1/prskalica2/stanje", String("0").c_str(),TRUE);
    }
      ...
      Stanje[2]='1';
      Stanje[3]='0';
      client.publish("bozaSub/kuca/node1/prskalica3/stanje", String("1").c_str(),TRUE);
    }
      ...
      Stanje[2]='0';
      Stanje[3]='0';
      client.publish("bozaSub/kuca/node1/prskalica3/stanje", String("0").c_str(),TRUE);
    }
      ...
      Stanje[2]='0';
      Stanje[3]='1';
      client.publish("bozaSub/kuca/node1/prskalica4/stanje", String("1").c_str(),TRUE);
    }
      ...
      Stanje[2]='0';
      Stanje[3]='0';
      client.publish("bozaSub/kuca/node1/prskalica4/stanje", String("0").c_str(),TRUE);
    }
    else if (incomingByte == 'o') {
      Stanje[4]='1';
      client.publish("bozaSub/kuca/node1/fontanaPumpa/stanje", String("1").c_str(),TRUE);
    }
    else if (incomingByte == 'p') {
      Stanje[4]='0';
      client.publish("bozaSub/kuca/node1/fontanaPumpa/stanje", String("0").c_str(),TRUE);
    }
    else if (incomingByte == 'a') {
      Stanje[5]='1';
      client.publish("bozaSub/kuca/node1/radio/stanje", String("1").c_str(),TRUE);
    }
    else if (incomingByte == 's') {
      Stanje[5]='0';
      client.publish("bozaSub/kuca/node1/radio/stanje", String("0").c_str(),TRUE);
    }
    else if (incomingByte == 'd') {
      Stanje[6]='1';
      client.publish("bozaSub/kuca/node1/neodredjeno/stanje", String("1").c_str(),TRUE);
    }
    else if (incomingByte == 'f') {
      Stanje[6]='0';
      client.publish("bozaSub/kuca/node1/neodredjeno/stanje", String("0").c_str(),TRUE);
    }
    else if (incomingByte == 'h') {
      client.publish("bozaSub/kuca/node1/prskalicaAll/stanje", String("1").c_str(),TRUE);
    }
      ...
      Stanje[2]='0';
      Stanje[3]='0';
      client.publish("bozaSub/kuca/node1/prskalicaAll/stanje", String("0").c_str(),TRUE);
    }
